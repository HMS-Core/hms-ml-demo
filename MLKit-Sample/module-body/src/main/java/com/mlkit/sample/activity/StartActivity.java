...
public final class StartActivity extends BaseActivity
    ...
    private static final int[] ICONS = {com.mlkit.sample.R.drawable.icon_face, R.drawable.icon_skeleton , R.drawable.icon_liveness,R.drawable.icon_handkeypoint};

    private static final int[] TITLES = { com.mlkit.sample.R.string.face_detection,
