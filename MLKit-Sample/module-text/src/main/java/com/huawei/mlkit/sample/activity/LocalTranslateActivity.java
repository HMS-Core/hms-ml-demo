...
public class LocalTranslateActivity extends BaseActivity {
    ...
    private static final List<String> SP_SOURCE_LIST_EN = new ArrayList<>(Arrays.asList("Auto", "Chinese", "English",
        "Spanish", "German", "Russian", "French", "Italian", "Portuguese", "Thai", "Arabic", "Turkish", "Japanese"
            , "Danish", "Polish", "Finnish", "Korean", "Swedish"));
    private static final List<String> DEMO_LIST = new ArrayList<>(Arrays.asList("Machine learning", "机器学习", "Machine learning",
            ...
            , "Maskinlæring", "Uczenie się maszyn", "Koneoppiminen", "기계 학습", "Inlärning av maskiner"));
    ...
    private static final List<String> SP_DEST_LIST_EN = new ArrayList<>(Arrays.asList("Chinese", "English", "Spanish",
        "German", "Russian", "French", "Italian", "Portuguese", "Thai", "Arabic", "Turkish", "Japanese"
            , "Danish", "Polish", "Finnish", "Korean", "Swedish"));

    private static final List<String> CODE_LIST = new ArrayList<>(
        Arrays.asList("zh", "en", "fr", "th", "ja", "de", "ru", "es", "ar", "tr", "pt", "it", "ro"
                , "da", "pl", "fi", "ko", "sv"));

    private static final List<String> LANGUAGE_LIST =
        new ArrayList<>(Arrays.asList("Chinese", "English", "French", "Thai", "Japanese", "German", "Russian",
            "Spanish", "Arabic", "Turkish", "Portuguese", "Italian", "Romanian"
                , "Danish", "Polish", "Finnish", "Korean", "Swedish"));

    private static final List<String> DOWNLOAD_LANG_LIST =
            new ArrayList<>(Arrays.asList("中文", "德语", "俄语", "法语", "意大利", "西班牙语", "葡萄牙", "泰语", "阿拉伯", "土耳其", "日语"
                    , "丹麦语", "波兰语", "芬兰语", "韩语", "瑞典语"));

    private static final List<String> DOWNLOAD_LANG_LIST_EN =
            new ArrayList<>(Arrays.asList("Chinese", "German", "Russian", "French", "Italian", "Spanish",
                    "Portuguese", "Thai", "Arabic", "Turkish", "Japanese"
                    , "Danish", "Polish", "Finnish", "Korean", "Swedish"));

    private static final List<String> DOWNLOAD_CODE_LIST = new ArrayList<>(
            Arrays.asList("zh", "de", "ru", "fr", "it", "es", "pt", "th", "ar", "tr", "ja"
                    , "da", "pl", "fi", "ko", "sv"));
    ...
    private TranslateDownloadAdapter downloadAdapter;
    private ArrayList<String> downloadModels = new ArrayList<>();
        ...
        manager.getModels(MLLocalTranslatorModel.class).addOnSuccessListener(new OnSuccessListener<Set<MLLocalTranslatorModel>>() {
            ...
            public void onSuccess(Set<MLLocalTranslatorModel> mlLocalTranslatorModels) {
                ...
                for (MLRemoteModel m : mlLocalTranslatorModels) {
                    downloadModels.add(m.getModelName().substring(m.getModelName().indexOf("_") + 1));
                }
                if (isEngLanguage()) {
    ...
    private void createSpinner() {
        if (this.isEngLanguage()) {
            this.spSourceAdapter = new TranslateSpinnerAdapter(this
                    , new ArrayList<String>(Arrays.asList(SOURCE_LANGUAGE_CODE)), downloadModels
            ...
            this.spDestAdapter = new TranslateSpinnerAdapter(this
                    , new ArrayList<String>(Arrays.asList(DEST_LANGUAGE_CODE)), downloadModels
        ...
        this.spSourceType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if( SOURCE_LANGUAGE_CODE.length > position) {
                    String langCode = SOURCE_LANGUAGE_CODE[position];
        ...
        this.spDestType.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if( DEST_LANGUAGE_CODE.length > position) {
                    String langCode = DEST_LANGUAGE_CODE[position];
