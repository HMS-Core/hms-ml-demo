...
import static com.huawei.mlkit.sample.photoreader.util.Constant.ML_CHINESE;
import static com.huawei.mlkit.sample.photoreader.util.Constant.ML_TTS_MAX_ALLOWED_CHAR_LENGTH;
