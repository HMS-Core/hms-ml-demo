...
import com.huawei.mlkit.sample.photoreader.kotlin.util.getEnumExtra
import com.huawei.mlkit.sample.photoreader.kotlin.util.putEnum
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>,
        ...
        if (isNeedShowDialog && !ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CALL_PHONE)) {
            val dialog = AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(getString(android.R.string.cancel)) { _: DialogInterface, _: Int -> finish() }.create()
            dialog.show()
        }
    }
